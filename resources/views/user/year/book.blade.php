...
<div class="heading-tag-2">
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class=" d-flex   row row-cols-2 row-cols-sm-2 row-cols-md-3 g-3">
      
                {{-- @if (!$books )

                <h2 class="bg-dark">No book published in this year</h2>
    ...
    @foreach($books as $data)
                ...
                <div class="col"> 
                    <div className="container mt-2 mb-5 col-md-3">
                        ...
                        <img  style="height:50%; width:50%; "src="{{url('/files/photo/'.$data->file)}}" alt="image">
